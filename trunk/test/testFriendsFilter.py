...
class TestFriendsFilter(CommonFilterTest):
    ...
    def testFriends(self):
        ...
        loader = UriLoader(analyzer=FriendsAnalyzer())
        ...
        foaf = loader.getFoafFrom(self.LIVEJOURNAL)
        self.assertEquals(len(foaf['friends']), 38)
